...
contract VaultEPTActions_RPC_tests is DSTest {
    ...
    function test_decreaseCollateral_redeem_underlier() public {
        ...
        hevm.roll(block.number + ((vault_yvUSDC_17DEC21.maturity(0) - block.timestamp) / 12));
        hevm.warp(vault_yvUSDC_17DEC21.maturity(0));
